        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FavoriteGenres = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ExchangeRequest_Book_BookId",
                        column: x => x.BookId,
                        principalTable: "Book",
                        principalColumn: "BookId");
                    table.ForeignKey(
                        name: "FK_ExchangeRequest_User_OwnerId",
                        column: x => x.OwnerId,
                        principalTable: "User",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ExchangeRequest_User_RequestId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequest_OwnerId",
                table: "ExchangeRequest",
                column: "OwnerId");

            migrationBuilder.CreateIndex(
                name: "IX_ExchangeRequest_RequestId",
                table: "ExchangeRequest",
                column: "RequestId");
